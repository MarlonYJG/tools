<!--
 * @Author: Marlon
 * @Date: 2020-03-20 10:37:48
 * @LastEditors: Marlon
 * @LastEditTime: 2020-03-26 11:21:01
 * @Description: 图表-饼图-基础
 -->
 <template>
  <div class="chart-view" :id="'chart_pie_'+this.elId"></div>
</template>
  ...
  methods: {
    draw() {
      let myChart = this.$echarts.init(
        document.getElementById(`chart_pie_${this.elId}`)
      );
      // 绘制图表
