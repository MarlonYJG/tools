<!--
 * @Author: Marlon
 * @Date: 2020-07-09 14:13:29
 * @LastEditors: Marlon
 * @LastEditTime: 2020-07-09 14:31:31
 * @Description: 防抖
--> 
<script>
...
export default {
  ...
  render(createElement, context) {
    ...
    if (vnode.tag === "input") {
      ...
      vnode.componentOptions &&
      vnode.componentOptions.tag === "el-button"
    ) {
      ...
      console.warn(
        "<debounce> 组件内只能出现下面组件的任意一个且唯一 el-button、el-input、button、input"
      );
      return vnode;
    }
    return vnode;
